              ...
              <div class="menu_section">
                ...
                <?php if(session()->get('level') == '6') { ?>
                  <ul class="nav side-menu">
                    ...
                    <li><a href="<?= base_url('/skripsi'); ?>"><i class="fa fa-edit"></i> Skripsi</a></li>
                  <li><a><i class="fa fa-edit"></i> Surat Akademik <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Seminar Proposal</a></li>
                ...
                <?php if(session()->get('level') == '4') { ?>
                  <ul class="nav side-menu">
                    <li><a href="<?= base_url('/'); ?>"><i class="fa fa-home"></i> Dashboard</a></li>
                    <li><a href="<?= base_url('/dosen_pembimbing'); ?>"><i class="fa fa-edit"></i> Dosen Pembimbing</a></li>
                  <li><a><i class="fa fa-edit"></i> Skripsi Mahasiswa <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="form_advanced.html">Daftar Sempro</a></li>
                      <li><a href="form_validation.html">Daftar Ujian Skripsi</a></li>
                      <li><a href="form_wizards.html">Daftar Skripsi</a></li>
                    </ul>
                  </li>
                </ul>
                <?php } ?>
